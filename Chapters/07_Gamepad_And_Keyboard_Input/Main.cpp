...
XInputGetState_Macro(XInputGetState_Stub) { return 0; }
...
XInputSetState_Macro(XInputSetState_Stub) { return 0; }
...
Internal void Win32_Load_XInput(void) {
    ...
    if (XInput_Lib) {
        XInputGetState = (XInputGetState_Func*)GetProcAddress(XInput_Lib, "XInputGetState");
        XInputSetState = (XInputSetState_Func*)GetProcAddress(XInput_Lib, "XInputSetState");
    }
}
